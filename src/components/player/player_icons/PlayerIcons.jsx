export function PlayIcon() {
  return (
    <svg id="icon-play" viewBox="0 0 15 20" xmlns="http://www.w3.org/2000/svg">
...
export function PauseIcon() {
  return (
    <svg id="icon-pause" viewBox="0 0 14 18" xmlns="http://www.w3.org/2000/svg">
...
export function PrevIcon() {
  return (
    <svg id="icon-prev" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg">
...
export function NextIcon() {
  return (
    <svg id="icon-next" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg">
